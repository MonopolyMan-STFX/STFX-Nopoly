   ...
   public PlayerView(MainBoard parent, Game game, Player player)
       {
        ...
        this.add(label);
       	...
       	// JComboBox propertiesDropDown = new JComboBox();
       	// for(int i = 0; i < playerProperties.size(); i++)
       	// {
       	//         propertiesDropDown.addItem(playerProperties.get(i).getName());
       	// }
       	// propertiesDropDown.setBounds(50,70,200,50);
       	// this.add(propertiesDropDown);


    //    String[] optionsToChoose = new String[playerProperties.size()];
